"""Round 5 G1: round-4 baseline + slow regime memory, shift reactivity, hysteresis."""
...
class Strategy(BaseStrategy):
    PARAMS = {
        ...
        # Regime memory (slow vs baseline vol/trend filters)
    ...
    def on_step(self, state: StepState):
        ...
        # --- regime memory: volatility + trend level + shift impulse, slow EMA + hysteresis ---
