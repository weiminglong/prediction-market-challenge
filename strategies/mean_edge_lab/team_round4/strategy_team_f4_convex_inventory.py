"""Local-trend baseline with convex inventory skew, side damping, and collateral-aware ask sizing."""
...
class Strategy(BaseStrategy):
    ...
    def _convex_inv_shift(self, net_inv: float) -> float:
        """Smoothstep-softened core; beyond inv_soft add mild cubic tail (capped |inv| for stability)."""
        p = self.PARAMS
        if net_inv == 0.0:
            return 0.0
