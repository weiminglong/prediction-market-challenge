"""V20: V17 + wider hit side (±4 instead of ±3).

Test if even more protection on the hit side helps.
"""
...
class Strategy(BaseStrategy):
    ...
    def on_step(self, state: StepState):
        ...
        bid_spread = 4 if self.last_buy_fill else 2
        ask_spread = 4 if self.last_sell_fill else 2
