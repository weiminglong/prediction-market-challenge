"""Exp H: Size 3.0 + 1-step cooldown — combine the two best ideas."""
...
class Strategy(BaseStrategy):
    ...
    def on_step(self, state: StepState):
        ...
        if state.buy_filled_quantity > 0:
            self.fill_bias -= 1.0
            self.bid_cooldown = 1  # 1-step cooldown
        ...
        bid_base = 0.8 if self.bid_cooldown > 0 else 3.0
        ask_base = 0.8 if self.ask_cooldown > 0 else 3.0
