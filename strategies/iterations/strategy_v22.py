"""V22: Best-of-breed combination.

Combines all winning elements:
- ±2 base spread (V10's finding: original spread was fine)
- Size 1.0 (key insight: starter's size 5 was the problem)
- Competitor momentum for better fair value (V13)
- Asymmetric spread: widen hit side to ±3 for 2 steps (V17+V21)
- Inventory skewing (0.06 coefficient)
- Fill bias with 0.5 decay
"""
...
class Strategy(BaseStrategy):
    ...
    def on_step(self, state: StepState):
        ...
        # Fill signal with asymmetric cooldown
        ...
        # Asymmetric spread: widen side on cooldown
        ...
        # Size 1.0 with inventory management
        max_inv = 30
