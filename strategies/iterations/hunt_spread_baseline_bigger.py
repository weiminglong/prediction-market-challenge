"""Baseline with bigger size: same ±2 spread but size 15 and inv_cap 8.

Control experiment: does simply increasing size from 10 to 15 help?
The original ±2 spread works well. Let's see if more volume = more edge.
"""
