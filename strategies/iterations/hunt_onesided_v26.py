"""v26: cooldown=1, safe-side boost=10 (same as normal), normal size=10.
Testing: does the zero on filled side alone give the boost, even without boosting safe side?"""
...
class Strategy(BaseStrategy):
    ...
    def on_step(self, state: StepState):
        ...
        # Zero on filled side, normal 10 on safe side (no boost)
        if self.bid_cooldown > 0:
            bid_size = 0.0
