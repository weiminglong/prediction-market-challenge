"""No-cooldown v4: same as v1 winner but with size=15 and inv_cap=8.

V1 was the best at 6.38. Push size higher and tighten inv_cap.
"""
...
class Strategy(BaseStrategy):
    ...
    def on_step(self, state: StepState):
        ...
        max_inv = 8
        bid_size = max(0.5, round(15.0 * vol_scale * max(0.0, 1.0 - net_inv / max_inv), 1))
        ask_size = max(0.5, round(15.0 * vol_scale * max(0.0, 1.0 + net_inv / max_inv), 1))
