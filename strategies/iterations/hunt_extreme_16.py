"""Extreme variant 16: Zero cooldown + cooldown 2 + BOTH fills trigger both cooldowns.
When ANY fill happens, withdraw from BOTH sides. This prevents the arb from sweeping
the other side right after. Size 10, inv_cap 10."""
...
class Strategy(BaseStrategy):
    ...
    def on_step(self, state: StepState):
        ...
        # Withdraw from both sides on any fill
        place_orders = self.cooldown == 0
