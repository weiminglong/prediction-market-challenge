"""No-cooldown v5: multi-level on top of no-cooldown.

Take the winning no-cooldown (fill_bias=1.5, decay=0.4) and add
a tiny inner ±1 level (size 0.5) during calm periods.
"""
