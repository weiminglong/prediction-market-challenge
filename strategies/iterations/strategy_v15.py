"""V15: ±2, size 0.8 — smaller than V10 to test diminishing returns."""
...
class Strategy(BaseStrategy):
    ...
    def on_step(self, state: StepState):
        ...
        max_inv = 25
        bid_size = max(0.2, 0.8 * max(0.0, 1.0 - net_inv / max_inv))
        ask_size = max(0.2, 0.8 * max(0.0, 1.0 + net_inv / max_inv))
