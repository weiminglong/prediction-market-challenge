"""Exp D: 1-step cooldown instead of 2.

Hypothesis: 2-step cooldown is too conservative — the fill info is stale
by step 2. Faster recovery means more time at full size capturing retail.
"""
