"""Baseline with inv_cap=7, size=10, spread=2.

Testing whether inv_cap 7 is a better sweet spot than 10.
The inv_cap controls how aggressively we reduce inventory.
Tighter cap = faster turnover but potentially miss some retail.
"""
