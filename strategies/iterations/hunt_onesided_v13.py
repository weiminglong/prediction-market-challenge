"""One-sided quoting v13: Stronger inv_skew + one-sided kill + wider spread.

The key might be stronger inv_skew to move fair value more aggressively,
combined with one-sided kill at lower threshold.
This skews the price more, making the reducing side naturally more attractive.
"""
...
class Strategy(BaseStrategy):
    ...
    def on_step(self, state: StepState):
        ...
        # Stronger inv skew to push fair value more
        ...
        # One-sided kill at |inv| > 3 with stronger fair value shift
        if net_inv > 3:
            bid_size = 0.0
