"""Extreme variant 10: Base spread 2, size 12, inv_cap 8, slightly stronger momentum (0.6).
Incremental improvement over baseline - just bump size from 10 to 12."""
...
class Strategy(BaseStrategy):
    ...
    def on_step(self, state: StepState):
        ...
        fair = mid + self.fill_bias + inv_skew + self.comp_momentum * 0.6
