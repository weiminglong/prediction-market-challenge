"""Proportional cooldown: post-fill size = base * 0.5 instead of flat 0.8. No momentum."""
...
class Strategy(BaseStrategy):
    ...
    def on_step(self, state: StepState):
        ...
        # Proportional cooldown: widen spread by 1 post-fill
        ...
        # Proportional sizing: 50% base during cooldown instead of flat 0.8
        base_size = 10.0
        bid_base = base_size * 0.5 if self.bid_cooldown > 0 else base_size
        ask_base = base_size * 0.5 if self.ask_cooldown > 0 else base_size
