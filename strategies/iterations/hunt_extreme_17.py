"""Extreme variant 17: Same as baseline but with size 10, inv_cap 7 (tighter than 10).
Testing if tighter cap alone improves things."""
...
class Strategy(BaseStrategy):
    ...
    def on_step(self, state: StepState):
        ...
        max_inv = 7  # tighter than baseline's 10
