"""No-cooldown v3: milder fill_bias, bigger size.

Try: fill_bias=1.0, decay=0.5 (same as original), no cooldown, size=12.
Maybe the benefit is simply from NOT widening, not from stronger bias.
"""
