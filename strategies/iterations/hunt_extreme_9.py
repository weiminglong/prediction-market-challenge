"""Extreme variant 9: Wider base spread (3 ticks), size 10, inv_cap 7, stronger momentum.
Hypothesis: wider spread = fewer arb fills, momentum helps dodge arb."""
...
class Strategy(BaseStrategy):
    ...
    def on_step(self, state: StepState):
        ...
        fair = mid + self.fill_bias + inv_skew + self.comp_momentum * 0.8  # stronger momentum

        vol_widen = 1 if self.vol_estimate > 1.0 else 0
        bid_spread = (4 if self.bid_cooldown > 0 else 3) + vol_widen  # wider base spread
