"""One-sided quoting v16: Pure baseline but with higher base size and lower inv cap.

What if the key is just cranking up size and lowering inv cap?
Base size 15, inv cap 8. No one-sided kill. Test if more volume = more edge.
"""
