"""Extreme variant 13: Very aggressive approach - size 10, inv_cap 6,
quadratic inv scaling with NO min floor, stronger fill_bias (1.5),
and inv_skew of 0.12. Cooldown size 0.5."""
...
class Strategy(BaseStrategy):
    ...
    def on_step(self, state: StepState):
        ...
        # Quadratic scaling, no min floor
        max_inv = 6
        bid_ratio = max(0.0, 1.0 - (max(0, net_inv) / max_inv) ** 2)
        ask_ratio = max(0.0, 1.0 - (max(0, -net_inv) / max_inv) ** 2)
