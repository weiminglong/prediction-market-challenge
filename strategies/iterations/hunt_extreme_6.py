"""Extreme variant 6: Size 15, inv_cap 8, linear scaling, inv_skew 0.08 (closer to original but bigger)."""
...
class Strategy(BaseStrategy):
    ...
    def on_step(self, state: StepState):
        ...
        # Linear scaling like original but with larger size and tighter cap
        max_inv = 8
