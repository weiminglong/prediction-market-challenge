"""Extreme variant 31: V26 + graduated comp spread signal.
comp_spread <= 4: spread 2 (tight)
comp_spread 5-6: spread 3 (medium)
comp_spread >= 7: spread 4 (wide)
Zero cooldown quoting."""
...
class Strategy(BaseStrategy):
    ...
    def on_step(self, state: StepState):
        ...
        # Graduated spread based on competitor spread
        if comp_spread >= 7:
            spread_widen = 2
        elif comp_spread >= 5:
            spread_widen = 1
