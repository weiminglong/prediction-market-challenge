"""One-sided quoting v14: Wider base spread (±3) + one-sided kill + large size 15.

Maybe the issue is that spread ±2 is too tight. Try ±3 base with large size.
Combined with one-sided kill at threshold=3.
"""
...
class Strategy(BaseStrategy):
    ...
    def on_step(self, state: StepState):
        ...
        # Wider base spread: 3 normal, 4 on cooldown
        bid_spread = (4 if self.bid_cooldown > 0 else 3) + vol_widen
        ask_spread = (4 if self.ask_cooldown > 0 else 3) + vol_widen
