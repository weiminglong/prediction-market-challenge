"""Extreme variant 30: V26 base + comp spread threshold 8 (wider = more rare widen).
Also: asymmetric comp spread signal - only widen on inventory-extending side."""
...
class Strategy(BaseStrategy):
    ...
    def on_step(self, state: StepState):
        ...
        spread_widen = 1 if comp_spread > 8 else 0
