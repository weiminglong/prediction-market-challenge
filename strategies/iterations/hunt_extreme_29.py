"""Extreme variant 29: V26 base + lower comp spread threshold (5 instead of 6).
Also test comp_spread > 4 as the widen trigger."""
...
class Strategy(BaseStrategy):
    ...
    def on_step(self, state: StepState):
        ...
        spread_widen = 1 if comp_spread > 5 else 0  # threshold 5 instead of 6
