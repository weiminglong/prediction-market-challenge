"""V14: ±2, size 1.2 — slightly bigger than V10 for more retail capture."""
...
class Strategy(BaseStrategy):
    ...
    def on_step(self, state: StepState):
        ...
        max_inv = 35
        bid_size = max(0.25, 1.2 * max(0.0, 1.0 - net_inv / max_inv))
        ask_size = max(0.25, 1.2 * max(0.0, 1.0 + net_inv / max_inv))
