"""V23: V22 + volatility-adaptive sizing.

When the competitor mid moves a lot (suggesting jumps), reduce size
to limit exposure. When calm, use full size.
"""
...
class Strategy(BaseStrategy):
    ...
    def on_step(self, state: StepState):
        ...
        # Competitor momentum and volatility
        ...
        # Volatility-adaptive size: reduce when volatile
