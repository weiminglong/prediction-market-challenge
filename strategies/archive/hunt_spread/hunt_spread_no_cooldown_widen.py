"""No cooldown widening: always ±2, use fill_bias to dodge arb instead.

Hypothesis: the cooldown widen to ±3 costs us retail fills. Instead,
rely entirely on fill_bias (which shifts fair value after fills) to
avoid getting arb'd again. Keep ±2 always, larger size.

The fill_bias naturally moves our quotes after a fill, which should
provide enough arb protection without widening the spread.
"""
...
class Strategy(BaseStrategy):
    ...
    def on_step(self, state: StepState):
        ...
        # Stronger fill_bias to compensate for no cooldown widening
