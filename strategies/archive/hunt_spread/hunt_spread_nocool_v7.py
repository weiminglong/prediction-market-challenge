"""No-cooldown v7: v5 winner with no vol_widen (always ±2).

What if vol_widen at ±3 is also hurting us, like cooldown did?
Try: always ±2, no matter what. Pure no-widening approach.
"""
