"""Direction A: cancel-all baseline (close to v28 behavior)."""
...
from strategies.mean_edge_lab.directions.common import normalize_competitor_quotes
...
class Strategy(BaseStrategy):
    ...
    def on_step(self, state: StepState):
        ...
        vol_scale = max(0.2, 1.0 - self.vol_estimate * 0.6)
