"""P1 o4 tox×trend guard + tiny symmetric L2/L3 pullback vs |fill_bias| (balanced, L2/L3 only)."""
...
class Strategy(BaseStrategy):
    ...
    _TT_VOL_SPAN = 0.22
    _TT_INV_SOFT = 1.15
    # Symmetric L2/L3-only responsiveness to elevated |tox|; milder than round16 r3 retuning.
    _L23_TOX_BAL_COEF = 0.030
    _L23_TOX_BAL_SCALE = 1.45
    ...
    def _l23_tox_balanced_scale(self) -> float:
        a = abs(self.fill_bias)
        return 1.0 - self._L23_TOX_BAL_COEF * math.tanh(a / max(1e-6, self._L23_TOX_BAL_SCALE))
    ...
    def on_step(self, state: StepState):
        ...
        l23_bal = self._l23_tox_balanced_scale()
        ...
        bid_sz2 = base_b2 * l23_b_scale * l23_bal
        ask_sz2 = base_a2 * l23_a_scale * l23_bal
        if bid_sz2 < ms:
            bid_sz2 = 0.0
        if ask_sz2 < ms:
            ask_sz2 = 0.0
        ...
        bid_sz3 = base_b3 * l23_b_scale * l23_bal
        ask_sz3 = base_a3 * l23_a_scale * l23_bal
        if bid_sz3 < ms:
            bid_sz3 = 0.0
        if ask_sz3 < ms:
            ask_sz3 = 0.0
