"""Combined MM with explicit risk-on / risk-off regime switch (hysteresis)."""
...
class Strategy(BaseStrategy):
    # Hysteresis: enter risk-off when raw >= HIGH; exit to risk-on when raw <= LOW
    _REGIME_HIGH = 0.58
    _REGIME_LOW = 0.40
    # Score weights: vol, trend magnitude, shock flag, fill toxicity
    _W_VOL = 0.28
    _W_TREND = 0.22
    _W_SHOCK = 0.32
    _W_TOX = 0.18
