"""Q2: p1 o4 tox×trend core + holdout-oriented depth throttle on vol bursts (not full shock)."""
...
class Strategy(BaseStrategy):
    ...
    # Slightly below baseline 0.58: calm paths (low vol_ema) unchanged; volatile holdouts lose L2/L3 sooner.
    ...
    _TT_VOL_SPAN = 0.205
    _TT_INV_SOFT = 1.15
    # Extra L2/L3 trim when vol_ema is elevated but below hard depth gate (seed0-friendly: ~0 until vol builds).
