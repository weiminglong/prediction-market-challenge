"""Q2 burst hardening: same q2+p1 holdout core; tighter depth gate + L2/L3 trim only on vol-burst windows."""
...
class Strategy(BaseStrategy):
    ...
    # Tighter than round15 0.505: drop L2/L3 sooner during vol-burst countdown only.
    _DEPTH_VOL_MAX_BURST = 0.478
    ...
    _VOL_BURST_STEPS = 4
    # Stronger trim than round15 0.935 when burst window active (L2/L3 only).
    _L23_BURST_SCALE = 0.898
