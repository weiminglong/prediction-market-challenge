"""One-sided quoting v4: threshold=5, reducing_size=30, accum_size=0.5, flat_size=10.

Conservative: only go one-sided at high inventory. Keep tiny presence on accum side.
"""
