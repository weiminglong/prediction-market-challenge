"""One-sided quoting v6: Conservative with wide spreads, proper bounds, smaller sizes.

Key insight: even reducing-side orders can be arb'd if spread is too tight.
Use wider spreads (±2 minimum), moderate sizes, and proper price clamping.
"""
...
class Strategy(BaseStrategy):
    ...
    def on_step(self, state: StepState):
        ...
        if net_inv > threshold:
            ...
            sell_collateral = (1.0 - my_ask * 0.01) * ask_size
            if sell_collateral <= state.free_cash:
