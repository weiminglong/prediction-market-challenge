"""v30: cooldown=1 zero + fill_bias multiplier 1.5 (stronger reaction to arb).

Stronger fill_bias signal: multiply by 1.5 to shift fair value more after arb.
This makes the safe-side quote even safer (more edge per fill).
"""
