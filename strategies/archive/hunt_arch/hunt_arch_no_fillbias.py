"""Full strategy with fill_bias removed. No fill-driven fair value shift."""
...
class Strategy(BaseStrategy):
    ...
    def on_step(self, state: StepState):
        ...
        # Cooldown triggered by fills, but no fill_bias shift on fair value
        ...
        # No fill_bias in fair value
        fair = mid + inv_skew + self.comp_momentum * 0.5
