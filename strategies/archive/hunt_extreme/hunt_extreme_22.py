"""Extreme variant 22: Aggressive position building.
When inventory is flat, use tight spread (1) and large size (15) to grab retail.
When inventory is extended (|inv| > 5), use wide spread (3) and small size.
The idea: aggressively build inventory from retail, then cautiously unwind."""
