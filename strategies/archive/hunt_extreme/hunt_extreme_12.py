"""Extreme variant 12: Size 10, inv_cap 10, but with ZERO cooldown quoting on fill side.
After getting filled, completely withdraw from that side for 2 steps.
Only quote safe side after fill. This should dramatically cut arb losses."""
...
class Strategy(BaseStrategy):
    ...
    def on_step(self, state: StepState):
        ...
        # On cooldown side, completely withdraw (no order at all)
