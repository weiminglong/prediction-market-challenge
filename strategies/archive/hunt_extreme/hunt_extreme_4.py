"""Extreme variant 4: Size 15, inv_cap 6, quadratic scaling, inv_skew 0.15, wider cooldown spread."""
...
class Strategy(BaseStrategy):
    ...
    def on_step(self, state: StepState):
        ...
        bid_spread = (4 if self.bid_cooldown > 0 else 2) + vol_widen  # wider cooldown spread
        ...
        bid_base = 0.5 if self.bid_cooldown > 0 else 15.0
        ask_base = 0.5 if self.ask_cooldown > 0 else 15.0
