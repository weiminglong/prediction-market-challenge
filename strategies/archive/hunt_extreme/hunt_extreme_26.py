"""Extreme variant 26: V21 (best so far) with tweaked parameters.
Zero cooldown + competitor spread signal + fill_bias 1.0 (not 1.2) + momentum 0.5.
Testing: does the competitor spread signal help without the other changes?"""
...
class Strategy(BaseStrategy):
    ...
    def on_step(self, state: StepState):
        ...
        spread_widen = 1 if comp_spread > 6 else 0
