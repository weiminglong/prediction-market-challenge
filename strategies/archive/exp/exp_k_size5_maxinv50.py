"""Exp K: Size 5.0 with max_inv 50 — test if inventory cap was throttling."""
...
class Strategy(BaseStrategy):
    ...
    def on_step(self, state: StepState):
        ...
        bid_base = 0.8 if self.bid_cooldown > 0 else 5.0
        ask_base = 0.8 if self.ask_cooldown > 0 else 5.0
